...
**Your Answers here:**
<br>1. To explain more than 50%, 6 factors are required.
<br>2. 5 yr T-Notes US (0.93)
<br>3. 
1: governments bonds and notes
2: Foreign currency
3. European stock index
4. North America stock index
5. Europoean bonds 
6. Oil and gas
7. Industrial metal
8. Commodities
...
then switch Future data with either pre_crisis_data or crisis_data. Also, it needs to change table to either table 1 or 2, eigenvalue 1 or eighenvalue 2, resuslt 1 or result 2..etc

<br>5. 
Components 1,2,3,5,6,9 have higher future increase on average during pre-crisis and Components 4,8,10 have higher future increase during crisis. In case of Compoenents 8 (staple commodities) does not have significant difference between crisis and pre-crisis.
...
**Your Answers here:**
<br>1. the code is about how much invest, how often at which interval, and based on which type of output
<br>2.Changes in MAfreq<-seq(10,250,by=20) results in how often a trading strategy is implemented depending on a window of moving average. And this changes also cuases changes in returns.
<br>
<br>
