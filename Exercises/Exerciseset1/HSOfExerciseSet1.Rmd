...
We can get the same resultw for Yahoo as well by adding Yahoo to dataSet1.R.
...
**Your Answers here:**
1. transposedData = t(StockReturns), nrow(StockReturns), ncol(StockReturns)
...
**Your Answers here:**
Change the date to 2000-12-29 which was last working date in 2000 and then we can get data from 2001-01-02 becase 2001-01-01 was a holiday.
...
**Your Answers here:**
<br>sum(myData != StockReturns[1:20,]) returns a value of 20 
<br>
<br>
<br>
